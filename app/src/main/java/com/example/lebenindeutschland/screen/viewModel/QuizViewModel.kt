package com.example.lebenindeutschland.screen.viewModel
...
import com.example.lebenindeutschland.domain.repo.Baden_Wurttemberg
import com.example.lebenindeutschland.domain.repo.Bayern
import com.example.lebenindeutschland.domain.repo.Berlin
import com.example.lebenindeutschland.domain.repo.Brandenburg
import com.example.lebenindeutschland.domain.repo.Bremen
import com.example.lebenindeutschland.domain.repo.Hamburg
import com.example.lebenindeutschland.domain.repo.Hessen
import com.example.lebenindeutschland.domain.repo.Mecklenburg_Vorpommern
import com.example.lebenindeutschland.domain.repo.Niedersachsen
import com.example.lebenindeutschland.domain.repo.Nordrhein_Westfalen
import com.example.lebenindeutschland.domain.repo.QuizModelList
import com.example.lebenindeutschland.domain.repo.QuizModelList2
import com.example.lebenindeutschland.domain.repo.QuizModelList3
import com.example.lebenindeutschland.domain.repo.QuizRepository
import com.example.lebenindeutschland.domain.repo.Rheinland_Pfalz
import com.example.lebenindeutschland.domain.repo.Saarland
import com.example.lebenindeutschland.domain.repo.Sachsen
import com.example.lebenindeutschland.domain.repo.Sachsen_Anhalt
import com.example.lebenindeutschland.domain.repo.Schleswig_Holstein
import com.example.lebenindeutschland.domain.repo.Thüringen
