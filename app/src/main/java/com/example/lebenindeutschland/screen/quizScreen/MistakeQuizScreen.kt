package com.example.lebenindeutschland.screen.quizScreen
...
import com.example.lebenindeutschland.screen.quizScreen.componenten.QuizItem
import com.example.lebenindeutschland.screen.quizScreen.componenten.noRippleClickable
...
@Composable
fun MistakeQuizScreen(navController: NavController) {

    val viewModel: QuizViewModel = hiltViewModel()
    val quizList = viewModel.allQuizFromDB.filter { it?.isCorOrNot == false }
        ...
        Column {
            if (!quizList.isNullOrEmpty()) {
                ...
                Column(
                    ...
                    Text(text = "Keine Letzter Fehler!", color = TextWhite, fontSize = 22.sp, fontWeight = FontWeight.Medium)
